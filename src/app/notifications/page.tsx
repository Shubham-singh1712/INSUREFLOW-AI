  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <MetricCard label="Unread" value={demoMode.enabled ? '7' : '0'} helper="Needs attention" tone="warning" />
        <MetricCard label="Critical" value={demoMode.enabled ? '2' : '0'} helper="Likely rejection blockers" tone="danger" />
        <MetricCard label="Resolved Today" value={demoMode.enabled ? '13' : '0'} helper="Closed by team actions" tone="success" />
      </div>
