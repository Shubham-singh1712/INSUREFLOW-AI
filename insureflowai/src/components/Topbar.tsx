        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden sm:block text-left">
              <p className="text-xs font-semibold text-foreground leading-tight">Sneha Rajan</p>
              <p className="text-xs text-muted-foreground">Insurance Desk</p>
            </div>
          ...
          {showProfile && (
            <div className="absolute right-0 top-full mt-2 w-52 bg-card rounded-2xl border border-border shadow-card-lg z-50 overflow-hidden fade-in">
              <div className="px-4 py-3 border-b border-border">
                <p className="text-sm font-semibold text-foreground">Sneha Rajan</p>
                <p className="text-xs text-muted-foreground">sneha.rajan@apollohospitals.in</p>
              </div>
              <div className="p-1.5">
