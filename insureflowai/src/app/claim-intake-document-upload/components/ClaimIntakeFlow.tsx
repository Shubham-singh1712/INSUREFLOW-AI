...
const steps = [
  { id: 'step-upload', number: 1, label: 'Document Upload', description: 'Upload hospital documents' },
  { id: 'step-gatekeeper', number: 2, label: 'Pre-Processing', description: 'Gatekeeper validation' },
  { id: 'step-extraction', number: 3, label: 'AI Extraction', description: 'Deep OCR & NLP mapping' },
  { id: 'step-review', number: 4, label: 'Review & Confirm', description: 'Verify extracted data' },
  { id: 'step-scrubbing', number: 5, label: 'Claim Scrubbing', description: 'Automated constraints' },
...
export default function ClaimIntakeFlow() {
  ...
  const [claimId] = useState('CLM-2852');
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
          <a href="/main-dashboard" className="hover:text-primary transition-colors">Dashboard</a>
