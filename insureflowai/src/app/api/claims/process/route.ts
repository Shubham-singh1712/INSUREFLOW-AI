...
function buildUiFields(fields: ExtractedFields): UiClaimField[] {
  ...
  return [
    ...
    toUi(
      'insuranceNumber',
      'Insurance number',
      fields.insurance.member_id.value ? fields.insurance.member_id : fields.insurance.policy_number
    ),
    toUi('diagnosis', 'Diagnosis', fields.clinical.diagnosis),
    ...
    toUi('procedure', 'Procedure', fields.clinical.procedure.value ? fields.clinical.procedure : fields.clinical.surgery),
    toUi(
      'invoiceTotal',
      'Invoice total',
      fields.financial.final_bill.value ? fields.financial.final_bill : fields.financial.total_claimed
    ),
    {
      id: 'claimType',
